...
namespace rotors_control {
    ...
    class PositionController{
        ...
        //private:
            ...
            state_t state_;
            void CalculateRotorVelocities(Eigen::Vector4d* ref_rotor_velocities, double* PWM_1, double* PWM_2, double* PWM_3, double* PWM_4);
            ...
            void AttitudeControllerFunction(double* p_command, double* q_command, double* theta_command, double* phi_command);
